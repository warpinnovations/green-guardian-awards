...
export default function BidCard({ bid }: { bid: BidCardBid }) {
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm font-medium text-gray-500">{bid.organization}</p>
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            ...
            <span className="text-gray-400">Submitted: {bid.submittedAt}</span>
          </div>
        </div>
      </div>
